/*
 * line-following-functions.cpp
 * LINE FOLLOWING FUNCTIONS: Makes the CrayolaBot in Exploration 2 follow lines.
 * NOTE: This is ONLY for CrayolaBots in Exploration 2. The Optosensors declared are never even initialized
 * */

#include "common.h"

// NOTE: THESE DON'T EXIST on the team's robot. They only exist on the CrayolaBot
extern AnalogInputPin leftOptosensor;
extern AnalogInputPin middleOptosensor;
extern AnalogInputPin rightOptosensor;

// NOTE: This is only for the CrayolaBots in Exploration 2
